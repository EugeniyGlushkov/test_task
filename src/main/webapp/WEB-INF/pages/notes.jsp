...
<%--<table>
    <tr>
        <td><a href="<c:url value='/movefirst'/>">first </a></td>
        <td><a href="<c:url value='/moveleft'/>"> <<< </a></td>
        <td align="center">${currentpage} from ${amountpages}</td>
        <td><a href="<c:url value='/moveright'/>"> >>> </a></td>
        <td><a href="<c:url value='/movelast'/>"> last</a></td>
    </tr>
</table>--%>
    ...
    <tr>
        <td>
            ...
            <form:form action="${addAction}" commandName="book">
                <table>
                        &lt;%&ndash;<c:if test="${!empty book.bookTitle}">&ndash;%&gt;
                    <tr>
                        <td>
                            <form:label path="id">
